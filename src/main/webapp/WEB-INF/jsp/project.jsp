 		...
 		<div class="row"><br/>
 			<div class="span12">
 				<div class="row">
 						...
 						<div class="span4"><span>Welcome <c:out value="${logedInUser.firstName}"></c:out>  <c:out value="${logedInUser.lastName}"></c:out></span> | <a href="/projectmanager/logout">Logout</a> |<a href="/projectmanager/posts">Forum</a>| <a href="/projectmanager/index.html">Home</a></div>
 				</div>
 			</div>
 		</div>

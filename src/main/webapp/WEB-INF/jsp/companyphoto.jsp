	...
	<div class="container">
		<div class="row">
			...
			<div class="span12">
				<div class="row">
					<div class="span8">
						<h1 class="page-header">Company Photos</h1>
					...
					<div class="span4">
						<span>Welcome <c:out value="${logedInUser.firstName}"></c:out>
							...
							<span><a href="/advert">Business Listing</a></span>
		...
		<div class="row">
			...
			<div class="span8">
				...
				<h2>Add a Photo for <c:out value="${company.name}"></c:out></h2>

				<form:form method="post" action="/addCompanyPhoto/${company.id}" commandName="photo" enctype="multipart/form-data">
				  <table>
				  	<tr><td colspan="2" style="color: red;"><form:errors path="*" cssStyle="color : red;"/>
				         ${errors}
         			</td></tr>
				    <tr>
				      <td><form:label path="content">Company Photo</form:label></td>
				...
				<c:if test="${!empty listCompanyPhoto}">
				  <table>
				    <tr>
				      <th>&nbsp;</th>
				    </tr>
				    <c:forEach items="${listCompanyPhoto}" var="companyPhoto">
				        <tr>
				        <td></td>
				       
				        <td><img src="${pageContext.request.contextPath}/companyphoto/${companyPhoto.id}" /> </td>
				        <td></td>
				        <td></td>
				      </tr>
				      <tr><td></td><td>
				      <c:choose>
					    <c:when test="${empty companyPhoto.newname}">
					    
					    	${companyPhoto.description}
				      ...
				      <tr><td></td><td><a href="/deleteCompanyPhoto/${companyPhoto.id}">Delete Photo</a></td></tr>

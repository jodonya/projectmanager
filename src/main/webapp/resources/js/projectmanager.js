...
$(function(){
    ...
    ***/
    ...
    request.onOpen = function(response) {
        content.html($('<p class="chat">', { text: 'Chatting using ' + response.transport }));
    ...
    request.onTransportFailure = function(errorMsg, request) {
        ...
        header.html($('<h4>', { text: 'Chat. Default transport is WebSocket, fallback is ' + request.fallbackTransport }));
    };
